...
representative of the fishery, and that units of effort are independent sampling 
units. Violating these assumptions (e.g., due to hierarchical sampling variance) 
...
number of sets). Landings (number or weight) do not represent independent 
sampling units unless an average independent fishing effort unit such as a trip 
lands less than or equal to one measurement unit of landings (e.g., <= one metric 
ton per trip).
